...
function solution(n, arr1, arr2) {
    ...
    function conversion(arr) {
        return arr.map(el => {
            const converted = [...el.toString(2)];
            const filler = [..."0".repeat(n - converted.length)];
            return filler.concat(converted);
        });
    }
}
let output1 = solution(5, [9, 20, 28, 18, 11],
    [30, 1, 21, 17, 28]);
// -> ["#####","# # #", "### #", "# ##", "#####"]
console.log(output1);

let output2 = solution(6, [46, 33, 33, 22, 31, 50],
    [27, 56, 19, 14, 14, 10]);
// -> ["######", "### #", "## ##", " #### ", " #####", "### # "]
console.log(output2);
