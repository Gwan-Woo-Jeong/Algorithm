...
let output1 = solution([1, 3, 2], [1, 2, 3]); // -> [0,1,1]
console.log(output1);

let output2 = solution([1, 4, 2, 3], [2, 1, 3, 4]); // -> [2,2,1,3]
console.log(output2);

let output3 = solution([3, 2, 1], [2, 1, 3]); // -> [1,1,2]
console.log(output3);

let output4 = solution([3, 2, 1], [1, 3, 2]); // -> [2,2,2]
console.log(output4);

let output5 = solution([1, 4, 2, 3], [2, 1, 4, 3]); // -> [2,2,0,2]
console.log(output5);